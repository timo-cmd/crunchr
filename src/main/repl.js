...
export class Repl {
    ...
    run() {
        console.log('Welcome to Crunchr neuronal network. REPL v.0.0.3');
        console.log('Type in expressions or load files synchronously!');
        ...
        scanner.on('line', (line) => {
            ...
            if (line === ':quit') {
                ...
                if (line === '' && prev === '') {
                    console.log('Blank lines typed. Starting a new expression.');
                    console.log();

                    prev = ' ';
                    input = '';
                    scanner.setPrompt(chalk.cyan('crunch> '));
